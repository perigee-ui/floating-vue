...
import { useClick, useFloating, useListNavigation } from '../src/index.ts'
...
const App = defineComponent({
	props: {
		list: {
			type: Object as PropType<Omit<Partial<UseListNavigationProps>, 'listRef'>>,
			default: undefined,
		},
	},
	setup(props) {
...
it.todo('opens on ArrowDown and focuses first item', async () => {
	...
	await expect.element(screen.getByTestId('item-0')).toHaveFocus()
})
