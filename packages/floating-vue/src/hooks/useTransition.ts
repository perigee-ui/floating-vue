...
export function useTransitionStatus<RT extends ReferenceType = ReferenceType>(
	...
	const closeDuration =
		(typeof duration === 'number' || typeof duration === 'function' ? duration : duration.close) || 0
...
type CSSStylesProperty = CSSProperties | ((params: { side: Side; placement: Placement }) => CSSProperties)
...
export function useTransitionStyles<RT extends ReferenceType = ReferenceType>(
	...
	const { duration = 250, common, open, close } = props
